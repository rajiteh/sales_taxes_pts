...
#
# However, when we do this, we also import `sales_taxes/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'sales_taxes_cli = sales_taxes.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'sales_taxes_gui = sales_taxes.gui:entry_point'
        # ]
    }
)
